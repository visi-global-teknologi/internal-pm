                ...
                <div class="card-body pt-0">
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <p class="text-muted mb-0 text-truncate">{{ app('string.helper')->changeNullWithDash(strtoupper($employee->employee_position->name)) }}</p>
                        </div>
                        <div class="col-sm-6">
                            <div class="pt-4">
                                <div class="row">
                                ...
                                <div class="mt-4">
                                    <a href="{{ route('user-profile.edit', ['id' => $employee->user_id]) }}" class="btn btn-primary waves-effect waves-light btn-sm">Edit Profile <i class="mdi mdi-arrow-right ms-1"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="table table-striped mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ app('string.helper')->changeNullWithDash(strtoupper($employee->employee_position->name)) }}</td>
                                </tr>
                                <tr>
