                ...
                <div class="card">
                    <div class="card-body">
                        <div class="tab-content" id="v-pills-tabContent">
                            @include('skote.pages.user-profile.detail', ['employee' => $employee, 'employeeDto' => $employeeDto])
                            @include('skote.pages.user-profile.change-password', ['employee' => $employee, 'employeeDto' => $employeeDto])
                        </div>
                    </div>
                </div>
            </div>
...
@section('script-bottom')
    <script src="{{ URL::asset('app/js/user-profile/change-password.js') }}"></script>
@endsection
