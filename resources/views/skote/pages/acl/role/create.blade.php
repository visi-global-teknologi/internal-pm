...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                {!! Form::open(['route' => 'api.private.acl.role.store', 'method' => 'POST', 'id' => 'form-acl-role-store']) !!}
                    <input required name="uuid_user_encrypted" type="hidden" class="form-control" value="{{ $userDto->uuid_encrypted }}">
                    <div class="row mb-4">
                        <label class="col-sm-3 col-form-label">Name</label>
                        <div class="col-sm-9">
                            <input required name="name" type="text" class="form-control" placeholder="Enter Role Name">
                        </div>
                    </div>
                    <div class="row justify-content-end">
                        <div class="col-sm-9">
                            <div>
                                ...
                                <button id="btn-submit-form-acl-role-store" type="submit" class="btn btn-primary w-md">Save</button>
                            </div>
                        </div>
                    </div>
...
@section('script-bottom')
    <script src="{{ URL::asset('app/js/acl/role/store.js') }}"></script>
@endsection
