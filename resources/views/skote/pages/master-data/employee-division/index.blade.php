...
@section('content')
    ...
    <div class="d-flex justify-content-end align-items-center py-2">
        <a href="{{ route('master-data.employee-divisions.create') }}" class="btn btn-primary w-m">Create Division</a>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <table id="employee-division-datatable" class="table table-bordered dt-responsive nowrap w-100">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Active Status</th>
    ...
    <input type="hidden" name="route_api_private_datatable_employee_division" value="{{ route('api.private.datatable.employee-division') }}"/>
@endsection
...
@section('script-bottom')
    <script src="{{ URL::asset('app/js/datatable/employee-division.js') }}"></script>
@endsection
