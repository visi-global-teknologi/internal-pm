...
@section('content')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <table id="employee-level-datatable" class="table table-bordered dt-responsive nowrap w-100">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Active Status</th>
    ...
    <input type="hidden" name="route_api_private_datatable_employee_level" value="{{ route('api.private.datatable.employee-level') }}"/>
@endsection
...
@section('script-bottom')
    <script src="{{ URL::asset('app/js/datatable/employee-level.js') }}"></script>
@endsection
