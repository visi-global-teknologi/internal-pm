...
@section('content')
    ...
    <div class="d-flex justify-content-end align-items-center py-2">
        <a href="{{ route('master-data.employee.levels.create') }}" class="btn btn-primary w-m">Create Level</a>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <table id="master-data-employee-level-datatable" class="table table-bordered dt-responsive nowrap w-100">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Active Status</th>
    ...
    <input type="hidden" name="route_api_private_datatable_master_data_employee_level" value="{{ route('api.private.datatable.master-data.employee.level') }}"/>
@endsection
...
@section('script-bottom')
    <script src="{{ URL::asset('app/js/datatable/master-data/employee/level.js') }}"></script>
@endsection
