                        ...
                        <div class="row justify-content-end">
                            <div class="col-sm-9">
                                <div>
                                    ...
                                    <button id="btn-submit-form-master-data-employee-level-store" type="submit" class="btn btn-primary w-md">Save</button>
                                </div>
                            </div>
                        </div>
...
@section('script-bottom')
    <script src="{{ URL::asset('app/js/master-data/employee/level/store.js') }}"></script>
@endsection
