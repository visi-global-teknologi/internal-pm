$(document).ready(function (e) {
    ...
    $("#master-data-employee-division-datatable").DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url: $("input[name=route_api_private_datatable_master_data_employee_division]").val(),
    ...
    $("#master-data-employee-division-datatable tbody").on("click", ".btn-danger", function () {
